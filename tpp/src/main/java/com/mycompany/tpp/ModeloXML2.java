 ...
 * 
 */
public class ModeloXML2 {
    public static Document adicionaPaisFactos(Factos pais, Document doc) {
        Element raiz;
        boolean found = false;
        ...
        pai.addContent(filho);
        filho = new Element("moeda").addContent(pais.getMoeda());
        pai.addContent(filho);
        filho = new Element("area").addContent(pais.getArea());
        pai.addContent(filho);
        filho = new Element("crescimentoPopulacional").addContent(pais.getCrescPopulacao());
        pai.addContent(filho);
        filho = new Element("cidadesMaisPopuladas").addContent(pais.getCidadesPopulosas());
        pai.addContent(filho);
        filho = new Element("dominioIT").addContent(pais.getDominioIT());
        pai.addContent(filho);
        filho = new Element("idiomas").addContent(pais.getIdiomas());
        pai.addContent(filho);
        filho = new Element("paisesVizinhos").addContent(pais.getPaisesVizinhas());
        pai.addContent(filho);
        /*
    ...
    public static Document removePaisFactos(String procura, Document doc){
        Element raiz;
        if(doc == null){
            raiz = new Element("lista");
            doc = new Document(raiz);
