...
public class JDOMFunctions_XSLT {
  ...
  public static Document transformaDocumento(Document XMLdoc, String xmlFile, String xslFile){
    ...
    public static Document transformaDocumento3(Document XMLdoc, String xmlFile, String xslFile, String continente){
    try {    
        // Remova a declaração de tipo do documento para garantir que a transformação funcione corretamente
        DocType d = XMLdoc.getDocType();
        if(d != null) {
            XMLdoc.setDocType(null);
            XMLJDomFunctions.escreverDocumentoParaFicheiro(XMLdoc, xmlFile);
        ...
        // Crie um novo transformador XSLT com o arquivo XSLT fornecido
        XSLTransformer transformer = new XSLTransformer(xslFile);
        
        // Adicione um parâmetro para representar o nome do continente
        //transformer.setParameter("continente", continente);
        
        // Transforme o documento XML
        Document doc2 = transformer.transform(XMLdoc);
